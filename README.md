...
| [Лекція 08](/DIP_Lec/LEC_DIP_08.pdf) | Фільтри сегментації (оператори Робертс, Превітт, Собель, дискретний Лапласіан) |          |
|                                      | **МОРФОЛОГІЧНІ ПЕРЕТВОРЕННЯ**                                |          |
| [Лекція 09](/DIP_Lec/LEC_DIP_09.pdf) | Загальні відомості,  структурний елемент, операції розширення, звуження, відкриття, закриття |          |
|                                      | **ПОРІВНЯННЯ ЗОБРАЖЕНЬ**                                     |          |
| [Лекція 10](/DIP_Lec/LEC_DIP_10.pdf) | Метрики подібності зображень. Метрики якості зображень. Хеш зображення. Ковзане вікно. |          |
|                                      | **СТИСНЕННЯ ЗОБРАЖЕНЬ**                                      |          |
| [Лекція 11](/DIP_Lec/LEC_DIP_11.pdf) | Стиснення без втрат                                          |          |
| [Лекція 12](/DIP_Lec/LEC_DIP_12.pdf) | Стиснення з втратами                                         |          |
...
[Основна](/LITR/Lit_Main.md)

[Допоміжна](/LITR/Lit_Dop.md)

[Інформаційні ресурси](/LITR/Info_Links.md)

[Бібліотеки](/LITR/Lib_Links.md)

### Розробник: професор Башков Є.О
